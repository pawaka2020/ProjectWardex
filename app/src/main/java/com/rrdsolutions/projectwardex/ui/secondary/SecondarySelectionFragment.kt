 ...
 * Use the [SecondarySelectionFragment.newInstance] factory method to
...
class SecondarySelectionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SecondarySelectionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SecondarySelectionFragment().apply {
