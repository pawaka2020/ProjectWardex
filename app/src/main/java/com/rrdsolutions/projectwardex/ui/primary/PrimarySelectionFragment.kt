 ...
 * Use the [PrimarySelectionFragment.newInstance] factory method to
...
class PrimarySelectionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PrimarySelectionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PrimarySelectionFragment().apply {
